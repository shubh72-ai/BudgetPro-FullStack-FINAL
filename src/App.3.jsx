...
const DS = {
  ...
  grad: {
    ...
    // Was a near-black navy gradient (#07080B → #151A23) left over from a pre-liquid-glass
    // dark theme. Every component below that references DS.grad.navy/navyMid/surface/hero
    // was rendering a genuine dark/black section on an otherwise white site. Retokenized to
    // the white-liquid-glass palette so all of those call sites update consistently from one place.
    navy:    "linear-gradient(155deg, #eef4ff 0%, #f3f0ff 48%, #ffffff 100%)",
    navyMid: "linear-gradient(135deg, #3b82f6 0%, #8b5cf6 100%)", // vivid blue→purple "recommended/selected" accent (white text stays legible on this)
    ...
    surface:"linear-gradient(155deg, #f8fbff 0%, #f3f7ff 48%, #ffffff 100%)",
    hero:   "radial-gradient(circle at 18% 18%, rgba(59,130,246,0.10), transparent 32%), radial-gradient(circle at 78% 20%, rgba(139,92,246,0.10), transparent 34%), radial-gradient(circle at 70% 78%, rgba(6,182,212,0.08), transparent 30%), linear-gradient(155deg, #ffffff 0%, #f8fbff 48%, #f3f7ff 100%)",
  ...
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 768px) {
      ...
      /* NOTE: previously ".sticky-cta { display: flex !important; }" lived here.
         That rule forced the floating CTA to always render on any screen ≤768px,
         overriding the React "visible" state (which only shows it after scrolling
         past the hero). This is the most likely cause of a floating popup appearing
         immediately and overlapping the hero/content on mobile. Removed intentionally —
         do not re-add a forced display rule for .sticky-cta. */
...
const StickyCTA = memo(({ visible }) => {
  ...
  return (
    <div className="sticky-cta" style={{
      position: "fixed", bottom: 20, right: 20, left: "auto", zIndex: 200,
      ...
      <div>
        <div style={{ color: DS.color.navy, fontWeight: 800, fontSize: 13, letterSpacing: 0 }}>🎯 Smart Expense Tracker</div>
      ...
      <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
        <button
          ...
          style={{ background: `linear-gradient(135deg, #3b82f6, #8b5cf6)`, color: "#fff", border: "none", padding: "9px 16px", borderRadius: "100px", fontSize: 12, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap", animation: "pulse 2s infinite" }}
        >
          Get ₹49
        </button>
      </div>
    ...
    <div style={{ animation: "fadeIn 0.4s ease" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 640, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: DS.color.slateLight, fontSize: 17, marginBottom: 44, lineHeight: 1.75 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <button
              ...
              style={{ background: "rgba(255,255,255,0.72)", backdropFilter: "blur(22px)", color: DS.color.navy, border: `1px solid ${DS.color.border}`, padding: "16px 32px", borderRadius: 100, fontSize: 16, fontWeight: 800, cursor: "pointer", boxShadow: "0 24px 80px rgba(15,23,42,0.08)" }}
            >
              Start Monthly for ₹19
            </button>
            <button
              onClick={() => goTo("/checkout?plan=yearly")}
              style={{ background: `linear-gradient(135deg, #3b82f6, #8b5cf6)`, color: "#fff", border: "none", padding: "16px 32px", borderRadius: 100, fontSize: 16, fontWeight: 800, cursor: "pointer", boxShadow: "0 4px 20px rgba(59,130,246,0.35)", animation: "pulse 2s infinite" }}
            >
              Get Full Year for ₹49
            </button>
          </div>
          <div style={{ marginTop: 28, color: DS.color.slateLight, fontSize: DS.type.sm }}>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div className="nav-desktop" style={{ display: "flex", gap: "10px", alignItems: "center" }}>
            <button
              onClick={() => goTo("/checkout?plan=monthly")}
              style={{ background: "transparent", color: DS.color.slate, border: `1px solid ${DS.color.border}`, padding: "9px 20px", borderRadius: "100px", fontSize: "14px", fontWeight: "700", cursor: "pointer" }}
            >
              Monthly ₹19
            </button>
            <button
              onClick={() => goTo("/checkout?plan=yearly")}
              style={{ background: `linear-gradient(135deg, #3b82f6, #8b5cf6)`, color: "#fff", border: "none", padding: "10px 22px", borderRadius: "100px", fontSize: "14px", fontWeight: "700", cursor: "pointer", boxShadow: "0 4px 14px rgba(59, 130, 246, 0.3)" }}
            >
              Full Year ₹49
            </button>
            <button
      ...
      {mobileOpen && (
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 12 }}>
            <button
              onClick={() => goTo("/checkout?plan=monthly")}
              style={{ background: "transparent", color: DS.color.slate, border: `1px solid ${DS.color.border}`, padding: "12px 14px", borderRadius: "100px", fontSize: 14, fontWeight: 700, cursor: "pointer" }}
            >
              Monthly ₹19
            </button>
            <button
              onClick={() => goTo("/checkout?plan=yearly")}
              style={{ background: `linear-gradient(135deg, #3b82f6, #8b5cf6)`, color: "#fff", border: "none", padding: "12px 14px", borderRadius: "100px", fontSize: 14, fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 14px rgba(59, 130, 246, 0.3)" }}
            >
              Full Year ₹49
            </button>
          </div>
...
const Footer = memo(() => {
  ...
  return (
    <footer style={{
      ...
      {/* Subtle orb */}
      <div style={{ position: "absolute", bottom: -80, right: -80, width: 300, height: 300, borderRadius: "50%", background: DS.color.mint, opacity: 0.06, pointerEvents: "none" }} />
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 44, marginBottom: 52 }}>
          ...
          <div>
            ...
            <p style={{ fontSize: DS.type.sm, lineHeight: 1.8, marginBottom: 24, maxWidth: 260, color: DS.color.slateLight }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button
                onClick={() => goTo("/checkout?plan=monthly")}
                style={{ background: "rgba(255,255,255,0.7)", color: DS.color.navy, border: `1px solid ${DS.color.border}`, padding: "9px 18px", borderRadius: "100px", fontSize: 13, fontWeight: 700, cursor: "pointer" }}
              >
                Monthly ₹19
              </button>
              <button
                onClick={() => goTo("/checkout?plan=yearly")}
                style={{ background: `linear-gradient(135deg, #3b82f6, #8b5cf6)`, color: "#fff", border: "none", padding: "9px 18px", borderRadius: "100px", fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 14px rgba(59,130,246,0.3)" }}
              >
                Full Year ₹49
              </button>
            </div>
          ...
          {/* Product links */}
          <div>
            <div style={{ fontWeight: 800, color: DS.color.navy, marginBottom: 18, fontSize: 13, letterSpacing: 0, textTransform: "uppercase" }}>
              Product
            </div>
            {[["/","Home"],["/#pricing","Pricing"],["/product","Product"]].map(([path,label]) => (
              <button
                ...
                onMouseEnter={(e) => e.target.style.color = DS.color.navy}
                onMouseLeave={(e) => e.target.style.color = DS.color.slateLight}
              >
                {label}
              </button>
            ))}
          ...
          <div>
            ...
            <div style={{
              ...
              <div className="price-font" style={{ fontSize: 26, fontWeight: 900, color: DS.color.navy, marginBottom: 2, letterSpacing: 0 }}>₹19</div>
              <div style={{ fontSize: DS.type.xs, marginBottom: 14, color: DS.color.slateLight }}>Monthly Smart Expense Tracker</div>
